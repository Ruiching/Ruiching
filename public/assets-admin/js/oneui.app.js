...
!function (e) {
    ...
    t.m = e, t.c = a, t.d = function (e, a, o) {
        ...
        if (t.r(o), Object.defineProperty(o, "default", {
                enumerable: !0,
                value: e
            }), 2 & a && "string" != typeof e)for (var n in e)t.d(o, n, function (a) {
            return e[a]
        }.bind(null, n));
        return o
    }, t.n = function (e) {
    ...
    var n = function () {
        ...
        return function (e, a, t) {
            a && o(e.prototype, a), t && o(e, t)
        }(e, null, [{
            key: "updateTheme", value: function (e, a) {
    ...
    var l, i = !1, s = function () {
        ...
        return function (e, a, t) {
            ...
            key: "run", value: function (e) {
                var a = this, t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, o = {
                ...
                if (e instanceof Array)for (var n in e)o[e[n]] && o[e[n]](t); else o[e] && o[e](t)
            }
        }, {
            key: "coreBootstrapTooltip", value: function () {
            ...
            key: "coreBootstrapPopover", value: function () {
            ...
            key: "coreBootstrapTabs", value: function () {
            ...
            key: "coreBootstrapCustomFileInput", value: function () {
            ...
            key: "coreToggleClass", value: function () {
            ...
            key: "coreScrollTo", value: function () {
                jQuery('[data-toggle="scroll-to"]:not(.js-scroll-to-enabled)').on("click.pixelcave.helpers.core", function (e) {
                    e.stopPropagation();
                    var a = jQuery("#page-header"), t = jQuery(e.currentTarget), o = t.data("target") || t.attr("href"), n = t.data("speed") || 1e3, r = a.length && jQuery("#page-container").hasClass("page-header-fixed") ? a.outerHeight() : 0;
                    t.addClass("js-scroll-to-enabled"), jQuery("html, body").animate({scrollTop: jQuery(o).offset().top - r}, n)
                })
            }
        }, {
            key: "coreYearCopy", value: function () {
                var e = jQuery('[data-toggle="year-copy"]:not(.js-year-copy-enabled)');
                if (e.length > 0) {
                    var a = (new Date).getFullYear(), t = e.html().length > 0 ? e.html() : a;
                    e.addClass("js-year-copy-enabled").html(parseInt(t) >= a ? a : t + "-" + a.toString().substr(2, 2))
                }
            }
        }, {
            key: "coreAppear", value: function () {
                jQuery('[data-toggle="appear"]:not(.js-appear-enabled)').each(function (e, a) {
                    var t = n.getWidth(), o = jQuery(a), r = o.data("class") || "animated fadeIn", l = o.data("offset") || 0, i = t < 992 ? 0 : o.data("timeout") ? o.data("timeout") : 0;
            ...
            key: "print", value: function () {
                var e = jQuery("#page-container"), a = e.prop("class");
                e.prop("class", ""), window.print(), e.prop("class", a)
            }
        }, {
            key: "tableToolsSections", value: function () {
            ...
            key: "tableToolsCheckable", value: function () {
                var e = this;
                jQuery(".js-table-checkable:not(.js-table-checkable-enabled)").each(function (a, t) {
                    ...
                    o.addClass("js-table-checkable-enabled"), jQuery("thead input:checkbox", o).on("click.pixelcave.helpers", function (a) {
                        ...
                        jQuery("tbody .custom-checkbox input:checkbox", o).each(function (a, o) {
                            var n = jQuery(o);
            ...
            key: "ckeditor", value: function () {
                jQuery("#js-ckeditor-inline:not(.js-ckeditor-inline-enabled)").length && (jQuery("#js-ckeditor-inline").attr("contenteditable", "true"), CKEDITOR.inline("js-ckeditor-inline"), jQuery("#js-ckeditor-inline").addClass("js-ckeditor-inline-enabled")), jQuery("#js-ckeditor:not(.js-ckeditor-enabled)").length && (CKEDITOR.replace("js-ckeditor"), jQuery("#js-ckeditor").addClass("js-ckeditor-enabled"))
            }
        }, {
            key: "simpleMDE", value: function () {
                jQuery(".js-simplemde:not(.js-simplemde-enabled)").each(function (e, a) {
                    var t = jQuery(a);
                    t.addClass("js-simplemde-enabled"), new SimpleMDE({element: t[0]})
                })
            }
        }, {
            key: "slick", value: function () {
            ...
            key: "highlightjs", value: function () {
            ...
            key: "easyPieChart", value: function () {
            ...
            key: "rangeslider", value: function () {
                jQuery(".js-rangeslider:not(.js-rangeslider-enabled)").each(function (e, a) {
                    jQuery(a).addClass("js-rangeslider-enabled").ionRangeSlider({input_values_separator: ";"})
                })
            }
        }, {
            key: "sparkline", value: function () {
                var e = this;
                jQuery(".js-sparkline:not(.js-sparkline-enabled)").each(function (a, t) {
                    var o = jQuery(t), n = o.data("type"), r = {}, s = {
                        line: function () {
    ...
    var d = function () {
        ...
        return function (e, a, t) {
            a && c(e.prototype, a), t && c(e, t)
        }(e, [{
            key: "_uiInit", value: function () {
            ...
            key: "_uiHandleSidebars", value: function (e) {
            ...
            key: "_uiHandlePageLoader", value: function () {
            ...
            key: "_uiHandleTheme", value: function () {
                var e = jQuery("#css-theme"), a = !!this._lPage.hasClass("enable-cookies");
                if (a) {
                ...
                jQuery('[data-toggle="theme"][data-theme="' + (e.length ? e.attr("href") : "default") + '"]').addClass("active"), this._lPage.off("click.pixelcave.themes"), this._lPage.on("click.pixelcave.themes", '[data-toggle="theme"]', function (t) {
                    t.preventDefault();
                    var o = jQuery(t.currentTarget), r = o.data("theme");
                    jQuery('[data-toggle="theme"]').removeClass("active"), jQuery('[data-toggle="theme"][data-theme="' + r + '"]').addClass("active"), n.updateTheme(e, r), e = jQuery("#css-theme"), a && Cookies.set("oneuiThemeName", r, {expires: 7}), o.blur()
                })
            }
        }, {
            key: "_uiApiLayout", value: function () {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "init", a = this;
            ...
            key: "_uiApiBlocks", value: function () {
                var e, a, t, o = this, n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "init", r = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], l = this, i = "si si-size-fullscreen", s = {
                    init: function () {
            ...
            key: "block", value: function (e, a) {
                this._uiApiBlocks(e, a)
            }
        }, {
            key: "loader", value: function (e, a) {
                this._uiHandlePageLoader(e, a)
            }
        }, {
            key: "helpers", value: function (e) {
